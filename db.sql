...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2022 at 01:07 AM
...
CREATE TABLE `registered_students` (
  ...
  `wassce_index_number` text NOT NULL,
  `wassce_year` int(11) NOT NULL,
...
--
ALTER TABLE `registered_students`
  ADD CONSTRAINT `registered_students_ibfk_1` FOREIGN KEY (`student`) REFERENCES `registered_schools` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
